          ...
          <div className="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-3  ">
            <div className="space-y-4 border border-purple-800 p-4 hover:scale-105 transition ease-in-out rounded-md hover:shadow-md">
              ...
              <div className="flex space-x-4 ml-4">
                <Link
                  href={
                    "https://github.com/DipakKhade/ClothInference/tree/main/clothinference"
                  }
                  target="_blank"
            ...
            <div className="space-y-4 border border-purple-800 p-4 hover:scale-105 transition ease-in-out rounded-md hover:shadow-md">
              ...
              <Link
                href={"https://github.com/DipakKhade/MSc-Project"}
                target="_blank"
                className="text-white bg-purple-500 hover:bg-purple-600 bg-primary-700 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                {" "}
                Visit repo
                <svg
            ...
            <div className="space-y-4 border border-purple-800 p-4 hover:scale-105 transition ease-in-out rounded-md hover:shadow-md">
              ...
              <p className="text-lg font-normal text-gray-600 dark:text-gray-800 ">
                Next js 14 , TypeScript , Tailwind CSS , upstash Database , Next
                Auth
              </p>
              <Link
                href={
                  "https://github.com/DipakKhade/messenging-Web-Application-with-Next.js"
                }
                target="_blank"
                className="text-white hover:bg-purple-400 bg-purple-300 bg-primary-700 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                {" "}
                Visit repo
                <svg
            ...
            <div className="space-y-4 border border-purple-800 p-4 hover:scale-105 transition ease-in-out rounded-md hover:shadow-md">
              ...
              <Link
                href={"https://github.com/DipakKhade/File-Sharing-webapp"}
                target="_blank"
                className="text-white bg-purple-500 hover:bg-purple-600 bg-primary-700 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                {" "}

...
const KnownThings: FC<KnownThingsProps> = () => {
  ...
  return (
    <>
      ...
      <div className="md:flex mr-6">
        {categories.map((category) => (
          <div
            key={category.title}
            className="md:w-[25vw] w-[80vw] p-4 bg-purple-200 border border-gray-200 dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75 text-gray-500 rounded-lg mt-8 shadow sm:p-8 ml-9"
          >
            <div className="flex items-center justify-between mb-4">
              <h5 className="text-xl font-bold leading-none text-gray-500">
                {category.title}
              </h5>
            </div>
            <div className="flow-root">
              <ul role="list" className="divide-y divide-purple-300 dark:divide-gray-200">

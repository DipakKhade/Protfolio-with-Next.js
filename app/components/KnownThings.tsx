  ...
  return (
    ...
    <div className=" md:flex">
      ...
      {categories.map((category) => (
        <div key={category.title} className="md:w-[25vw] w-[80vw] p-4 bg-blue-200 border border-gray-200 rounded-lg mt-8 shadow sm:p-8 ml-9">
          <div className="flex items-center justify-between mb-4">
            <h5 className="text-xl font-bold leading-none  text-black">{category.title}</h5>
          </div>
